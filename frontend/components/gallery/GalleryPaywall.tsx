...
export function GalleryPaywall({ images, characterName }: Props) {
              ...
              >
                <img
                  ...
                  className={cn(
                    ...
                    !isFree && "scale-110 blur-md",
                  )}
                />

                {/* Every tile gets a clickable overlay. Free = opens lightbox.
                    Locked = opens upgrade modal. Using a div with role=button
                    instead of <button> to avoid browser default focus ring. */}
                {isFree ? (
                  <div
                    role="button"
                    tabIndex={0}
